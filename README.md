    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p>Calculate</p>
          <div class="w3-light-grey w3-round-red w3-small">
            <div class="w3-container w3-center w3-round-red w3-teal" style="width:90%">90%</div>
            
          </div>
          <p>Acting</p>
          <div class="w3-light-grey w3-round-red w3-small">
            <div class="w3-container w3-center w3-round-red w3-teal" style="width:80%">
              <div class="w3-center w3-text-white">80%</div>
            </div>
          </div>
          <p>Media</p>
          <div class="w3-light-grey w3-round-red w3-small">
            <div class="w3-container w3-center w3-round-red w3-teal" style="width:75%">75%</div>
          </div>
          <br>
